...
echo '<table class="fichaDireccion" border="0">
                  <tr>
                    <td>
                        <div class="icono">
                    ...
                    <td colspan="3">'.htmlspecialchars($direccion).'</td>
                  </tr>
                  <tr>
                    <td>
                        <div class="icono">
                    ...
                    <td>
                        <a href="tel:'.htmlspecialchars($tel1).'" target="_blank">
                            '.telefono(htmlspecialchars($tel1)).'
                        </a>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                        <a href="tel:'.htmlspecialchars($tel2).'" target="_blank">
                            '.telefono(htmlspecialchars($tel2)).'
                        </a>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>
                        <a target="_blank" href="'.htmlspecialchars($website).'">'.htmlspecialchars($website).'</a>
                    </td>
                  </tr>
                </table>';
