...
<div class="slider" style="position: relative;">
    <div>
        <iframe class="iframeMovil" title="slider principal" src="sliders/sliderMarcas.php" loading="lazy" scrolling="no" frameborder="0" style="width: 100%;max-width:1000px;height:358px;"></iframe>
    </div>
</div>
